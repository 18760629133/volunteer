                ...
                <c:forEach items="${myProjectList}" var="project">
                    <tr>
                        ...
                        <c:if test="${project.state==1}">
                            <td class="success">进行中</td>
                            <td ><a href="javascript:" onclick="del(this,${project.projectid})"><li class="fa fa-trash-o fa-fw"></li></a></td>
                        </c:if>
                        <c:if test="${project.state==2}">
                            <td class="success">已结束</td>
                            <td></td>
                        </c:if>
                    </tr>
                </c:forEach>
...
<script>
    ...
    function del(obj,id) {
        $.ajax({
            url:'${pageContext.request.contextPath}/project/delUser_Project',
            data:{id:id},
            type:'get',
            dataType:'json',
