        ...
        <div class="container">
            ...
            <div id="navigation" class="collapse navbar-collapse navbar-right">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="${pageContext.request.contextPath}/page/addproject.jsp">志愿发布</a></li>
        ...
        <div class="row">
            <div class="col-lg-9">
                <div class="box-simple">
                    ...
                    <div class="content">
                        <h4>志愿发布</h4>
                        <p class="text-muted">Send Valunteer Message</p>
                        <form id="projectBox">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="needperson">招募人数</label>
                                        <span class="form-checked-red" aria-hidden="true">*</span>
                                        <input id="needperson" type="text" class="form-control" name="needperson">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <span class="form-checked-red" aria-hidden="true">*</span>
                                        <input id="servicetime" type="text" class="form-control" placeholder="示例：2019-12-10 8:00至10:00" name="servicetime">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="place">服务地点</label>
                                        <span class="form-checked-red" aria-hidden="true">*</span>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="provide">提供的志愿者保障</label>
                                        <input id="provide" type="text" class="form-control" name="provide">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <button type="button" onclick="add()" class="btn btn-primary"><i class="fa fa-mail-forward"></i>发布信息</button>
                                    </c:if>
                                    <c:if test="${empty user}">
                                        <button type="button" onclick="add()" disabled="disabled" class="btn btn-primary"><i class="fa fa-mail-forward"></i>发布信息</button>
                                    </c:if>
                                </div>
                            </div>
                        </form>
            ...
            <div class="col-lg-3" id="tips">
                <p><i class="fa fa-gittip" id="mess_logl"></i>温馨提示</p>
                <p>任何人都可以发布志愿信息，待管理员审核通过后，即为发布成功.</p>
            </div>
...
<script>
    function add() {
        $.ajax({
           url:'${pageContext.request.contextPath}/checkProject/userAddProject',
            data:$("#projectBox").serialize(),
            dataType:'json',
            type:'post',
