...
<section>
    <div id="contact" class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="box-simple">
                        ...
                        <div class="content">
                            <h4>身份证</h4>
                            <p><strong>${sessionScope.user.userid}</strong></p>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-5">
            <div class="col-md-12">
                <div class="box-simple">
                    ...
                    <div class="content">
                        <h4>电话号码</h4>
                        <p><strong>${sessionScope.user.phone}</strong></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="box-simple">
                    ...
                    <div class="content">
                        <h4>邮箱</h4>
                        <p><strong>${sessionScope.user.email}</strong></p>
                        <p class="text-muted"></p>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-3">
            <div class="col-lg-12">
                <div class="image"><img src="${pageContext.request.contextPath}/img/project_04.jpeg" alt="" class="img-responsive"></a></div>
            </div>
        ...
        <div class="col-lg-12">
            <div class="box-simple">
                ...
                <div class="col-sm-5">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <button type="button" onclick="goToChangeMyInfo()" class="btn btn-primary">&nbsp;&nbsp;修改个人信息&nbsp;&nbsp;</button>
                </div>
            </div>
        </div>
...
<script>
    function goToChangeMyInfo() {
        window.location.href="${pageContext.request.contextPath}/page/change_myinfo.jsp";
    }
