...
<section>
    <div id="contact" class="container">
        ...
        <form action="${pageContext.request.contextPath}/user/udateInfo" method="post">
        ...
        <div class="col-lg-5">
            <div class="col-md-12">
                <div class="box-simple">
                    ...
                    <div class="content">
                        <h4>电话号码</h4>
                        <input id="phone" type="text" name="phone" class="form-control" value="${sessionScope.user.phone}">
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="box-simple">
                    ...
                    <div class="content">
                        <h4>邮箱</h4>
                        <input id="email" name="email" type="text" class="form-control" value="${sessionScope.user.email}">
                        <p class="text-muted"></p>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-3">
            <div class="col-lg-12">
                <div class="image"><img src="${pageContext.request.contextPath}/img/project_04.jpeg" alt="" class="img-responsive"></div>
            </div>
