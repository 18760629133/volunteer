...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/lib/datatables/media/css/dataTables.bootstrap4.min.css">
...
<div class="container-fluid">
    <div class="col-lg-12" >
        <div class="col-lg-3">
            <img src="${pageContext.request.contextPath}/img/project_logo02.jpg" class="img-responsive"/>
        </div>
        <div class="col-lg-7">
            <table class="table table-hover" id="dataTable">
                ...
                <tbody>
                <c:forEach items="${myCheck}" var="project">
                    <tr>
                        <td></td>
                        <td>${project.projectid}</td>
                        <td>${project.name}</td>
                        <td>${project.servicetime}</td>
                        <td>${project.place}</td>
                        <c:if test="${project.state==0}">
                            <td class="success">审核中</td>
                            <td>
                                <a href="javascript:" onclick="del(this,${project.projectid})"><li class="fa fa-trash-o fa-fw"></li></a>
                            </td>
                        </c:if>
                        <c:if test="${project.state==1}">
                            <td class="success" style="color: green">已通过</td>
                            <td></td>
                        </c:if>
                        <c:if test="${project.state==2}">
                            <td class="" style="color: red">未通过</td>
                            <td></td>
                        </c:if>
                    </tr>
                </c:forEach>
...
<script src="${pageContext.request.contextPath}/datatables/media/js/jquery.dataTables.min.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/datatables/media/js/dataTables.bootstrap4.min.js" type="text/javascript"></script>
...
<script>
    ...
    function del(obj,id) {
        $.ajax({
           url:'${pageContext.request.contextPath}/checkProject/del',
           data:{id:id},
            type:'get',
            dataType:'json',
