        ...
        <div class="container">
            ...
            <div id="navigation" class="collapse navbar-collapse navbar-right">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="${pageContext.request.contextPath}/message/getAllMessage?currentPage=1">意见中心</a></li>
            ...
            <form id="messageBox">
                ...
                <div class="col-sm-12">
                    <c:if test="${!empty user}">
                        <button type="button" onclick="sendMessage()"  class="btn btn-primary"><i class="fa fa-comment"></i> Send message</button>
                    </c:if>
                    <c:if test="${empty user}">
                        <button type="button" onclick="sendMessage()" disabled="disabled" class="btn btn-primary"><i class="fa fa-comment"></i> Send message</button>
                    </c:if>
                </div>
            ...
            <div class="col-sm-12"  style="text-align: center; margin-top: 18px;">
                <nav aria-label="Page navigation">
                    <ul class="pagination pagination-lg">
                        ...
                        <c:if test="${messagePageBean.currentPage!=1 }">
                        <li>
                            <a href="${pageContext.request.contextPath }/message/getAllMessage?currentPage=${messagePageBean.currentPage-1}" aria-label="Previous">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        <li>
                            </c:if>
                        ...
                        <c:if test="${messagePageBean.currentPage!=page }">
                            <li><a href="${pageContext.request.contextPath }/message/getAllMessage?currentPage=${page}">${page}</a></li>
                        </c:if>
                        ...
                        <li>
                            ...
                            <c:if test="${messagePageBean.currentPage!=messagePageBean.totalPage }">
                        <li>
                            <a href="${pageContext.request.contextPath }/message/getAllMessage?currentPage=${messagePageBean.currentPage+1}" aria-label="Next">
                                <span aria-hidden="true">&raquo;</span>
                            </a>
                        <li>
                            </c:if>
