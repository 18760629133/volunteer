...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/datatables/media/css/dataTables.bootstrap.min.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/datatables/media/css/jquery.dataTables.min.css">
    ...
    <div class="post-content margin-bottom--big">
        <div class="col-lg-7">
               <table id="dataTable" class="table">
                   ...
                   <tbody>
                   <c:forEach items="${info}" var="article">
                       <tr>
                           <td ><a href="${pageContext.request.contextPath}/article/getArticleById?id=${article.id}">${article.title}</a></td>
                           <td >${article.time}</td>
                       </tr>
                   </c:forEach>
                   </tbody>
        ...
        <div class="col-lg-3" id="info_right">
            ...
            <div class="box box-services">
                ...
                <h4 class="services-heading"><a href="${pageContext.request.contextPath}/message/getAllMessage?currentPage=1">意见中心</a></h4>
                <p>Opinion Centre </p>
            </div>
        </div>
    </div>
...
<script src="${pageContext.request.contextPath}/datatables/media/js/dataTables.bootstrap.min.js" type="text/javascript"></script>
