    ...
    <form class="layui-form ok-form" lay-filter="filter">
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="userid" placeholder="请输入身份证" autocomplete="off" class="layui-input" lay-verify="identity">
            </div>
        </div>
        <div class="layui-form-item">
...
<script>
    layui.use(["element", "form", "laydate", "okLayer", "okUtils"], function () {
        ...
        form.on("submit(add)", function (data) {
            okUtils.ajax("${pageContext.request.contextPath}/user/addUser", "post", data.field, true).done(function (response) {
